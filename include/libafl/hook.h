...
struct libafl_pre_memrw_hook {
    void (*callback)(uint64_t data, target_ulong pc, target_ulong addr, target_ulong size, target_ulong *out_addr);
    uint64_t data;
};
extern struct libafl_pre_memrw_hook* libafl_pre_memrw_hooks;
size_t libafl_add_pre_memrw_hook(void (*callback)(uint64_t data, target_ulong pc, target_ulong addr, target_ulong size, target_ulong *out_addr),
                                        uint64_t data);
