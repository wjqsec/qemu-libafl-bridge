...
//// --- Begin LibAFL code ---
    ...
    gen_helper_libafl_qemu_pre_memrw(temp_out,temp_tcgv_i64(tcgv_ptr_temp(b)),tcg_constant_i64(memop_size(get_memop(oi))), tcg_constant_i32(0));
...
//// --- Begin LibAFL code ---
    ...
    MemOpIdx oi = make_memop_idx((type - TCG_TYPE_V64) + MO_64, 0);
    TCGv_i64 temp_out =  tcg_temp_ebb_new_i64();
    gen_helper_libafl_qemu_pre_memrw(temp_out,temp_tcgv_i64(tcgv_ptr_temp(b)),tcg_constant_i64(memop_size(get_memop(oi))), tcg_constant_i32(1));
    b = temp_tcgv_ptr(tcgv_i64_temp(temp_out));
//// --- End LibAFL code ---
