...
//// --- Begin LibAFL code ---
    ...
    gen_helper_libafl_qemu_pre_memrw(temp_out,temp_tcgv_i64(tcgv_i64_temp(b)),tcg_constant_i64(memop_size(get_memop(oi))));
    b = tcgv_ptr_temp(tcgv_i64_temp(temp_out));
//// --- End LibAFL code ---
