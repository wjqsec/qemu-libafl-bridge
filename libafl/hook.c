...
size_t libafl_add_pre_memrw_hook(void (*callback)(uint64_t data, target_ulong pc, target_ulong addr, uint64_t size, target_ulong *out_addr, uint32_t rw, __uint128_t value),
                                        uint64_t data)
{
